...
exports.Game = exports.isPromoting = void 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            SocketManager_1.socketManager.broadcast(this.gameId, JSON.stringify({
                ...
                payload: {
                    gameId: this.gameId,
                    whitePlayer: {
                        name: (_b = users.find((user) => user.id === this.player1UserId)) === null || _b === void 0 ? void 0 : _b.name,
                        id: this.player1UserId,
                    },
                    blackPlayer: {
                        name: (_c = users.find((user) => user.id === this.player2UserId)) === null || _c === void 0 ? void 0 : _c.name,
